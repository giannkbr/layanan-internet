  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
      ...
      <li class="nav-item <?= $title == 'Item Package' | $title == 'Category Package'  ? 'active' : '' ?>">
        ...
        <div id="collapseTwo"
          class="collapse <?= $title == 'Item Package' | $title == 'Category Package' ? 'show' : '' ?>"
          aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item <?= $title == 'Item Package'  ? 'active' : '' ?>"
              href="<?= site_url('package/item') ?>">Item</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item <?= $title == 'Income' | $title == 'Expenditure' | $title == 'Report'  ? 'active' : '' ?>">
        ...
        <div id="collapseReport"
          class="collapse <?= $title == 'Income' | $title == 'Expenditure' | $title == 'Report' ? 'show' : '' ?>"
          aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item <?= $title == 'Income'  ? 'active' : '' ?>"
              href="<?= site_url('income') ?>">Pemasukan</a>
            <a class="collapse-item <?= $title == 'Expenditure'  ? 'active' : '' ?>"
              href="<?= site_url('expenditure') ?>">Pengeluaran</a>
      ...
      <li class="nav-item <?= $title == 'Admin' | $title == 'Add admin' ? 'active' : '' ?>">
      ...
      <div id="collapseSetting"
        class="collapse <?= $title == 'Setting' | $title == 'About' | $title == 'Bank'  ? 'show' : '' ?>"
        aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item <?= $title == 'Setting'  ? 'active' : '' ?>"
            href="<?= site_url('setting') ?>">Perusahaan</a>
          <a class="collapse-item <?= $title == 'About'  ? 'active' : '' ?>"
            href="<?= site_url('setting/about') ?>">Tentang Perusahaan</a>
          <a class="collapse-item <?= $title == 'Carousel'  ? 'active' : '' ?>"
            href="<?= site_url('setting/carousel') ?>">Carousel</a>
          <a class="collapse-item <?= $title == 'Bank'  ? 'active' : '' ?>"
            href="<?= site_url('setting/bank') ?>">Rekening Bank</a>
        </div>
      </div>

...
<div class="col-lg-12">
  ...
  width: 100%;" alt=""> <br>
                    ...
                    <div class="form-group">
                        <label for="due_date">Jatuh Tempo Pelanggan</label> <small>* Semua Pelanggan</small>
                        <select name="due_date" id="du_date" class="form-control">
                            <option value="<?= $company['due_date'] ?>"><?= $company['due_date'] ?></option>
                            <?php
                            for ($i = 28; $i >= 28 - 27; $i -= 1) {
                            ?>

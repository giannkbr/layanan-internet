...
<head>
    ...
    <title>Laporan Pengeluaran <?php if ($tanggal && $tanggal2 !== '') {
                                ?>
    ...
    <div class="book">
        <div class="page">
            ...
            <div class="title text-center">
                <h6 style="font-weight: bold;">Laporan Pengeluaran
                    <?php if ($tanggal && $tanggal2 !== '') {
                    ?>
                        Dari Tanggal <?= indo_date($tanggal) ?> Sampai Tanggal <?= indo_date($tanggal2) ?></h6>
            <?php } ?></h6>
            </div>
